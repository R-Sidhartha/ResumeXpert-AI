...
import { SubscriptionButton } from "../(main)/billing/SubscriptionButton";
        ...
        <>
            <nav className="w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <Link href="/" className=" flex gap-2 items-center justify-center text-lg font-semibold text-gray-800 dark:text-white hover:text-green-600">
                        <Image src={logo} alt="Logo" width={100} />
                    </Link>
                    <span className="text-sm text-gray-500 dark:text-gray-400">Choose your plan</span>
                </div>
            </nav>
                                    ...
                                    {["Free", "Xpert-Pro", "Xpert-Elite"].map((plan, i) => (
                                        <td key={i} className={clsx(
                                            ...
                                            {plan === "Free" ? (
                                                ...
                                                <Link
                                                    href="/sign-up"
                                                    className="inline-flex justify-center min-w-[150px] px-4 py-2 text-sm font-medium text-white bg-green-900 rounded-lg hover:bg-green-700"
                                                >
