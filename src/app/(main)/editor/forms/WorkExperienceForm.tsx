        ...
        const { unsubscribe } = form.watch(async (values) => {
            ...
            setResumeData({
                ...
                workExperiences: values.workExperiences
                    ...
                    .map((exp) => ({
                        ...exp,
                        description: exp.description?.filter((desc) => desc !== undefined) || [],
                    })) || [],
            });
        });
        return unsubscribe;
            ...
            <Form {...form}>
                <form className="space-y-3">
                    ...
                    <div className="flex justify-center">
                        ...
                        >
                            <PlusCircle className="size-5" /> Add work experience
                        </Button>
                    </div>
                </form>
            </Form>
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <BulletTextarea
                                ...
                                onChange={(newValue) => form.setValue(`workExperiences.${index}.description`, newValue)}
                            />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
